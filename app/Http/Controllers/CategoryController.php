...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('manager.categories.allcats',compact("category","subcategory",$category,$subcategory));
    }
    ...
    public function view_subcat($id){
        ...
        $subcategory = subcategory::where('category_id',$id)->get()->sortBy('sequence');
        return view('manager.categories.subcats',compact("subcategory","id"));
    }
    ...
    {
        return view('manager.categories.new');
    }
    public function new_subcat($id){
        return view('manager.categories.new_subcat',compact("id"));
    }
    ...
    public function edit($id)
    {
        ...
        return view('manager.categories.edit', compact("category","subcategry"));
    }
     ...
     */
     ...
     public function subcat_edit($catid,$id){
         $subcategry = subcategory::find($id);
          return view('manager.categories.edit_subcat', compact("subcategry","catid"));
     }
