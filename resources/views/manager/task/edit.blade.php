                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                  ...
                                  <form enctype="multipart/form-data" action="{{ route('task_update' ,$vehicles->id) }}"  method="post">
                                    @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="vehicle_issue" class="form-control" id="" cols="30" rows="4"  placeholder="Enter Your Issue." readonly>{{ $vehicles->vehicle_issue}}</textarea>
                                    </div> 

                                    
                                        <div class="form-group">
                                            <label for="booking_date">Vehicle Booking Date</label>
                                            <input type="text" id="booking_date" class="form-control" name="booking_date" value="{{ $vehicles->booking_date}}" placeholder="select Booking Date" readonly>
                                        </div>

 
                                        <div class="form-group">
                                            <label for="ending_date">Finish Date</label>
                                            <input type="text" id="ending_date" class="form-control" value="{{ $vehicles->ending_date}}" name="ending_date" placeholder="Select Finish Date" >
                                        </div>
