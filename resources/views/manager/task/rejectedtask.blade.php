                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                @foreach($vehicles as $key => $vehicle)
                                    ...
                                    <tr id="{{$vehicle->id}}"> 
                                        ...
                                        <td> 
                                        <a href="{{ route('assign_task' ,$vehicle->id) }}" class="btn btn-outline-primary">Assign Task</a>
                                         <a href="{{ route('del_task' ,$vehicle->id) }}"onclick="return confirm('Are you sure you want to Delete this task permanently?');"  class="btn btn-outline-danger">Delete</a>
                                        </td>
                                    </tr> 
                                @endforeach
