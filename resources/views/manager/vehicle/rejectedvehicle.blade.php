                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                @foreach($vehicles as $key => $vehicle)
                                    ...
                                    <tr id="{{$vehicle->id}}"> 
                                        ...
                                        @elseif ( $vehicle->status == "Progress" )
                                        ...
                                        <td> 
                                        <a href="{{ route('accept_request' ,$vehicle->id) }}" onclick="return confirm('Are you sure you want to Accept this Request?');" class="btn btn-outline-success">Accept</a>  
                                        <a href="{{ route('del_request' ,$vehicle->id) }}"onclick="return confirm('Are you sure you want to Permonently Delete this Request?');"  class="btn btn-outline-danger">Delete</a>
                                        </td>
                                    </tr> 
                                @endforeach
