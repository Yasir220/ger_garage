                                ...
                                <div class="col-md-12">
                                  ...
                                  <form enctype="multipart/form-data" action="{{ route('banner_update' ,$banner->id) }}"  method="post">
                                   @method('PUT')
                                    ...
                                    <div class="form-group">
                                        <label for="caption_portugal">Caption In Portugal</label>
                                        <input type="text" class="form-control" required="" id="caption_portugal" value="{{$banner->caption_portugal}}" name="caption_portugal"class="form-control" placeholder="Enter Caption In Portugal">
                                    </div>
