  ...
  <div class="form-group">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <input  type="number" class="form-control" value="{{$product->sale_price}}" required="" id="sale_price" name="sale_price" placeholder="Enter Product sale price">
        </div>
        <div class="col-md-4">
        <label for="wholesale_price">Wholesale Price</label>
        <input  type="number" class="form-control" required="" value="{{$product->wholesale_price}}" id="wholesale_price" name="wholesale_price" placeholder="Enter Product Whole sale price">
        </div>
    </div> 
</div>
...
<div class="form-group">
  <div class="row" >
      ...
      <div class="col-md-6">
          ...
          <input  type="number" class="form-control" required=""  value="{{$product->mqo}}" id="min_prod_qty" name="min_prod_qty" placeholder="Minimum product for odering.">
      </div>
 ...
 <div class="form-group">
  ...
  <div class="row" style="background-color:lightgray; padding-bottom:10px;">
      ...
      <div class="form-group">
          ...
          <input  type="text" class="form-control" required=""  value="{{$product->meta_title}}" id="meta_title" name="meta_title" placeholder="Enter Meta Tile for Product.">  
      </div>

      <div class="form-group">
          <label for="meta_discription">Meta Description</label> 
          <textarea class="form-control" type="text"   id="meta_description" name="meta_description" placeholder="Enter Meta Discription for Product." rows="3">{{$product->meta_description}}</textarea>
      </div>
  </div> 
</div>
