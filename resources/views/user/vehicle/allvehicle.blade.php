                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                @foreach($vehicles as $key => $vehicle)
                                    ...
                                    <tr id="{{$vehicle->id}}"> 
                                        ...
                                        <td> 
                                        <a href="{{ route('vehicle_edit' ,$vehicle->id) }}" class="btn btn-outline-info">Edit</a> 
                                        <a href="{{ route('del_vehicle' ,$vehicle->id) }}"onclick="return confirm('Are you sure you want to delete this item?');"  class="btn btn-outline-danger">Delete</a>
                                        </td>
                                    </tr> 
                                @endforeach
