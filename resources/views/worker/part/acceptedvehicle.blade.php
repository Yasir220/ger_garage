                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Repairing Vehicles</h3>
                            <p class="text-subtitle text-muted">For view the vehicle and add parts.</p>
                        </div>
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{route('worker.login')}}">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Repairing Vehicles</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                @foreach($vehicles as $key => $vehicle)
                                    ...
                                    <tr id="{{$vehicle->id}}"> 
                                        ...
                                        <td>  
                                        <a href="{{ route('addvehicle_part' ,$vehicle->id) }}"  class="btn btn-outline-primary">Add</a>
                                        <a href="{{ route('reject_repair' ,$vehicle->id) }}"onclick="return confirm('Are you sure you done the work?');"  class="btn btn-outline-success">Done</a>
                                        </td>
                                    </tr> 
                                @endforeach
