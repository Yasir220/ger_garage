                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Add Parts</h3>
                            <p class="text-subtitle text-muted">Complete all input fields for adding New Part for particular Vehicle.</p>
                        </div>
                ...
                <section class="section ">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">For Add new Parts</h4>
                        </div>
                     ...
                     <form enctype="multipart/form-data" action="{{route('store_part')}}"  method="post">
                        ...
                        <div class="row">
                          ...
                          <select class="form-control" id="sub_category" required="" name="sub_category"> 
                           ...
                           <div class="col-md-6">
                              ...
                              <div> <input type="number" class="form-control" required="" id="qnty" name="qnty" placeholder="Enter Part quantity"> 
                           </div>
                          </div>
                          ...
                          <div class="col-md-12" style="padding-top: 20px;">
                           ...
                           <div>
                              <textarea class="form-control" type="text"  id="message"  name="message" placeholder="Enter Discription" placeholder="Enter Product Discription" required rows="3"></textarea>
                           </div>
                          </div>

                          <input type="hidden" id="vehicle" name="vehicle" value="{{$id}}" >
