                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Vehicle For Repairing Requests</h3>
                            <p class="text-subtitle text-muted">For checking the request for vehicle which is for repairing.</p>
                        </div>
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                @foreach($vehicles as $key => $vehicle)
                                    ...
                                    <tr id="{{$vehicle->id}}"> 
                                        ...
                                        <td> 
                                        <a href="{{ route('accept_repair' ,$vehicle->id) }}" class="btn btn-outline-success">Accept</a> 
                                        <a href="{{ route('reject_repair' ,$vehicle->id) }}"onclick="return confirm('Are you sure you want to Reject this Request?');"  class="btn btn-outline-danger">Reject</a>
                                        </td>
                                    </tr> 
                                @endforeach
