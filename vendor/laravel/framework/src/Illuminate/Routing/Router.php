...
class Router implements RegistrarContract, BindingRegistrar
{
    ...
    public function emailVerification()
    {
        ...
        $this->get('email/verify/{id}', 'Auth\User\VerificationController@verify')->name('verification.verify');
        $this->get('email/resend', 'Auth\User\VerificationController@resend')->name('verification.resend');
    }
